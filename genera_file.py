...
riga = ["PIH", 10, 11, 8.49315452575684, 3, 14, 10, "1999-05-08", "NYSE", "\"1347 PROPERTY INSURANCE HOLDINGS, INC.\"", "FINANCE", "PROPERTY-CASUALTY INSURERS"]
...
def aggiungi_nuove_righe(file_originale, fattore_scala):
    with open(file_originale, "a", newline='') as f_originale:
        ...
        data_inizio = datetime.strptime(riga[7], "%Y-%m-%d")
        date_consecutive = genera_date_iniziali(data_inizio, 2000)
        ...
        while i < fattore_scala:
            ...
            for data in date_consecutive:
                ...
                nuova_riga[7] = data.strftime("%Y-%m-%d")  # Modifica la data
...
# File originale CSV
file_originale_1 = "input/merged_data_1.csv"
file_originale_2 = "input/merged_data_2.csv"
file_originale_3 = "input/merged_data_3.csv"
